% chatenium-ol-adwaita(SECTION) | User Commands
%
% "January  6 2026"
...
chatenium-ol-adwaita - program to do something

# SYNOPSIS

**chatenium-ol-adwaita** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**chatenium-ol-adwaita** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **chatenium-ol-adwaita** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**chatenium-ol-adwaita** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    chatenium-ol-adwaita. See **foo.conf**(5) for further details.
...
**chatenium-ol-adwaita** provides some return codes, that can be used in scripts:
